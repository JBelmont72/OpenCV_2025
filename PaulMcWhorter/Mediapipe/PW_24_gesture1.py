'''PW_24_gesture1.py
first work on identifying gestures. 
will use the handTrackModule.py  (must be in same folder as this progam)
Will only use the def Marks() from handTrackModule ( my object is 'findHands')
frame, handsLM, handsType = findHands.Marks(frame, draw=False) hand
'''
