'''
learn how to not only detect faces in an image, but also recognize who the person is. We start by training our model with known faces, 
...
unknownFace=FR.load_image_file('images/demoImages/unknown/u1.jpg')
