...
# font=cv2.FONT_HERSHEY_SIMPLEX
 ## the below was from CV_16 homework where we entered PATHS
...
# '''
# with open('/Users/judsonbelmont/Documents/SharedFolders/OpenCV/OpenCV_3/PaulMcWhorter/pickleData.pkl','rb') as f:
# # with open('images/train.pkl','rb') as f:
#     names = pickle.load(f)
...
########~~~~~~~19 Jan 2025 https://toptechboy.com/ai-for-everyone-homework-solution-face-recognition-with-live-video-in-opencv/
...
# janFace=FR.load_image_file('images/demoImages/known/Jan.jpg')
# faceLoc=FR.face_locations(janFace)[0]
# janFaceEncode=FR.face_encodings(janFace)[0]
 
# judFace=FR.load_image_file('images/demoImages/known/Judson.jpg')
# faceLoc=FR.face_locations(judFace)[0]
# judFaceEncode=FR.face_encodings(judFace)[0]
 
# knownEncodings=[janFaceEncode,judFaceEncode]
# names=['Jan','Judson']
